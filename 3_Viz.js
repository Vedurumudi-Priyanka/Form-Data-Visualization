...
// Note: In the CSV file 10th row, 4th column, response is "Fiji, Kapan".
//       Fiji and Kapan are two separate places in the world, 
//       so that is considered as 2 separate responses
